...
function BlockRenderer({ block, assets, formConfig, loading, error }) {
  ...
  switch (block.block_type) {
    ...
    case "form":        return <FormBlock        settings={s} formConfig={formConfig} loading={loading} error={error} />;
...
export default function PublicLandingBlocks({ blocks = [], assets = [], formConfig, loading, error }) {
  const active = blocks
